...
urlpatterns = [
    ...
    path('alterar_senha/',login_required(auth_views.PasswordChangeView.as_view(success_url=reverse_lazy('logar_usuario'))),name='alterar_senha'),
    path('alterar_senha/sucesso',usuario_views.senha_alterada, name='senha_alterada'),
